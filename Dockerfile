...
# slirp4netns
# TODO: remove in favour of netavark + pasta?!
...
# netavark
FROM rust:1.78-alpine3.19 AS netavark
RUN apk add --update --no-cache git make musl-dev protoc
...
ARG PASST_VERSION=2024_05_10.7288448
